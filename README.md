...
<img src="https://skillicons.dev/icons?i=python,typescript,nodejs,nextjs,tailwind,git,github,vscode&theme=dark" alt="Python, TypeScript, Node.js, Next.js, Tailwind, Git, GitHub, VS Code" />
...
| :--- | :--- | :--- |
| **[docurag](https://github.com/jhonkomar/docurag)** | Chat with your documents — upload a PDF or Word file and get answers grounded in its actual content. | `Python` `RAG` |
| **[newsletter-agent](https://github.com/jhonkomar/newsletter-agent)** | Autonomous agent that searches, scrapes, summarizes and delivers news on any topic straight to your inbox. | `Python` `Agents` |
| **[crosspost](https://github.com/jhonkomar/crosspost)** | Discord bot that publishes one piece of content to multiple social platforms at once. | `Python` `Automation` |
| **[cold-reach](https://github.com/jhonkomar/cold-reach)** | Finds local businesses without websites on Google Maps and reaches out over WhatsApp — driven from Discord. | `Python` `Playwright` |
| **[n8n-ugc-pipeline](https://github.com/jhonkomar/n8n-ugc-pipeline)** | Turns overnight content ideas into ready-to-post UGC videos. | `n8n` `Gemini` |
| **[n8n-auto-clip-pipeline](https://github.com/jhonkomar/n8n-auto-clip-pipeline)** | Auto-generates short clips from YouTube videos and publishes them to TikTok. | `n8n` `Klap` |
